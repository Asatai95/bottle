...
<body>
  ...
  <form action="/test" method="post">
    ...
    <script src="https://checkout.stripe.com/v2/checkout.js"  name="stripeToken" class="stripe-button" data-key="{{ key }}" data-locale="auto" data-amount="500 " data-name="TEST" data-currency="jpy" data-image="https://stripe.com/img/documentation/checkout/marketplace.png" data-locale="ja"></script>
  </form>
